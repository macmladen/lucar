...
<article class="prose">
  ...
  <!-- ... -->
            ...
            <p>
              For more information about how to use the plugin and the features
              it includes,{' '}
            ...
            <p>
              ...
              closer together than a paragraph followed by a heading should be.
            </p>
            ...
            <ul>
              <li>
                ...
                <p>
                  ...
                  so the hard part is getting the spacing between the
                  paragraphs, list item heading, and separate list items to all
                  make sense. Pretty tough honestly, you could make a strong
                  argument that you just shouldn't write this way.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                ...
                <p>
                  ...
                  having no trouble making up arbitrary things to type, I might
                  as well include it.
                </p>
              </li>
            </ul>
